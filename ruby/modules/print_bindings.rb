...
# SETUP
 $tempfile=File.open("C:\\Temp\\LIMbindings.txt",  'w') 
 project = 'C:\\project\\Exxon\\etkLim\\model\\'
 folder = 
# 'fabricatedModules'
# 'dataEntryEquipment'
# 'bulk_And_Other'
...
#directory = 'C:\\Documents and Settings\\rbrindamour\\workspace\\ExxonMobil\\emetk\\etkLim\\model\\dataEntryEquipment'
